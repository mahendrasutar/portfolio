        ...
        <div className={styles.main}>
            <div id="header" className={styles.header}>
                <div className={styles.header_name}>
                    ...
                    <div className={styles.header_mahendra}>
                        <h1>
                            <AnimatedTitle title="I'm Mahendra." />
                        </h1>
                    </div>
                </div>
                <div className={styles.header_para}>
                    <div className={styles.para}>
                        <p>
                            <AnimatedText content="A UI/UX designer and an open source enthusiast." />
                            <br />
                        </p>
                    </div>
                    <div className={styles.resume_project}>
                        ...
                        >
                            <div className={styles.view_buttons}>
                                <Link
                                    target="_blank"
                                    href="https://drive.google.com/file/d/1avqvMRYF0LjKltTYVLYsc3p9KXIHOhEa/view?usp=sharing"
                                >
                                    <h5>Resume.</h5>
                                </Link>
                            </div>
