        ...
        <div className={styles.main}>
            ...
            >
                ...
                <div className={styles.design_skills}>
                    ...
                    <p>
                        <AnimatedText content="Figma, Adobe XD, Typography, Color Theory, Visual Hierarchy, Design Systems, Framer, Prototypeing, Responsive Design
" />
                    </p>
                </div>
                ...
                <div className={styles.user_research}>
                    ...
                    <p>
                        <AnimatedText content="User Research, Personas, User Journeys, Information Architecture, Sitemaps, Usability Testing, UserTesting, UX Writing" />
                    </p>
                </div>
